...
HD_PWD='C:/Users/xvanek41/MPC_PLD/cviceni_3/cviceni_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt_bin_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnt_bin_tb.tcl
